...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S Joker2 -X kill
screen -S Joker2 ./Joker2
done
]])
Run:close()
...
LuaTele = luatele.set_config{api_id=10332903,api_hash='17598f27636c07b3c8a14327828e6e02',session_name=Joker2,token=Token}
function var(value)  
...
return{
BanAll = Redis:sismember(Joker2.."Joker2:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Joker2.."Joker2:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Joker2.."Joker2:BanGroup:Group"..ChatId,UserId) ,
...
local msg_id = msg.id
Redis:incr(Joker2..'Joker2:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
local Num_Msg_Max = Redis:hget(Joker2.."Joker2:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_Max = Redis:hget(Joker2.."Joker2:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
Redis:incr(Joker2.."Joker2:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Joker2.."Joker2:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Joker2.."Joker2:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Joker2.."Joker2:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Joker2.."Joker2:Lock:Contact"..msg_chat_id)
...
{
{text = 'Source Joker2', url='https://t.me/UU_Joker2'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(Joker2.."Joker2:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Joker2..'Joker2:'..v..text)
end
Redis:del(Joker2.."Joker2:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Joker2.."Joker2:List:Rd:Sudo", text)
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Joker2.."Joker2:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Joker2.."Joker2:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Joker2.."Joker2:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Joker2.."Joker2:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✯︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Joker2.."Joker2:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Joker2.."Joker2:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Joker2.."Joker2:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Joker2.."Joker2:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Joker2.."Joker2:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Joker2.."Joker2:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Joker2.."Joker2:Change:Name:Bot"..msg.sender.user_id) 
...
--download('https://raw.githubusercontent.com/AhmedElsayed111/BOBXV/master/Joker2.lua','Joker2.lua')
...
LuaTele.sendText(msg_chat_id,msg_id,'*•عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n•عدد المجموعات : '..(Redis:scard(Joker2..'Joker2:ChekBotAdd') or 0)..'\n•عدد المشتركين : '..(Redis:scard(Joker2..'Joker2:Num:User:Pv') or 0)..'*',"md",true)  
end
...
Redis:set(Joker2.."Joker2:Status:Id"..msg_chat_id,true) ;Redis:set(Joker2.."Joker2:Status:Reply"..msg_chat_id,true) ;Redis:set(Joker2.."Joker2:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Joker2.."Joker2:Status:BanId"..msg_chat_id,true) ;Redis:set(Joker2.."Joker2:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Joker2.."Joker2:BotFree") then
...
local NumberGames = Redis:get(Joker2.."Joker2:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Joker2.."Joker2:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Joker2.."Joker2:Set:Id:Groups") or Redis:get(Joker2.."Joker2:Set:Id:Group"..msg_chat_id)
...
local Info_Members = Redis:smembers(Joker2.."Joker2:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."Joker2:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Joker2.."Joker2:photo:Rank"..msg_chat_id,true) 
...
Redis:set(Joker2.."Joker2:Status:BanId"..msg_chat_id,true) 
...
Redis:del(Joker2.."Joker2:photo:Rank"..msg_chat_id) 
...
Redis:del(Joker2.."Joker2:Status:BanId"..msg_chat_id) 
...
if Redis:sismember(Joker2.."Joker2:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Joker2:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Joker2.."Joker2:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Joker2.."Joker2:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"•تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Joker2.."Joker2:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Joker2:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."Joker2:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Joker2:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"•تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"•تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Joker2:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:get(Joker2.."Joker2:Status:BanId"..msg.chat_id)  then
...
data = {
{
{text = '- قناة السورس', url = 't.me/UU_Joker2'}, 
},
...
LuaTele.sendText(msg_chat_id,msg_id,'•عدد جهاتك المضافه هنا *~ '..(Redis:get(Joker2.."Joker2:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(Joker2.."Joker2:BanAll:Groups") 
...
Redis:del(Joker2.."Joker2:BanGroup:Group"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Joker2..'Joker2:Channel:Join')}, },}}
...
Redis:setex(Joker2.."Joker2:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Joker2.."Joker2:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Joker2.."Joker2:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Joker2.."Joker2:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
photo = "https://t.me/UU_Joker2VX/647"
local RinkBot = msg.Name_Controller
...
{{text = '◉ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆  .', url = 't.me/UU_Joker2'}}, 
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/UU_Joker2VX/646&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Redis:setex(Joker2.."Joker2:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local NamesBot = (Redis:get(Joker2.."Joker2:Name:Bot") or "سناك")
local BotName = {
'اسمي  '..NamesBot..'🖤',
'اسمي '..NamesBot..'❤️',
'اسمي  '..NamesBot..'♥️',
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/UU_Joker2'}, 
},
{
...
if text == (Redis:get(Joker2.."Joker2:Name:Bot") or "سناك") then
local photo = LuaTele.getUserProfilePhotos(Joker2)
local UserInfo = LuaTele.getUser(Joker2)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local CmdStart = '*\n•أهلآ بك في بوت '..(Redis:get(Joker2.."Joker2:Name:Bot") or "سناك")..
...
{
{text = '- قناة السورس.', url = 't.me/UU_Joker2'},{text = '- لتنصيب بوتك', url = 'https://t.me/xb8bbot'}, 
},
}
}
...
if not msg.ControllerBot and not Redis:set(Joker2.."Joker2:SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/UU_Joker2'}, },}}
...
if not msg.ControllerBot then
if Redis:get(Joker2.."Joker2:TwaslBot") and not Redis:sismember(Joker2.."Joker2:BaN:In:Tuasl",msg.sender.user_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Joker2:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Joker2:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الزخرفه بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الزخرفه بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(Joker2..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(Joker2..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(Joker2..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(Joker2.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الابراج بنجاح'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Joker2..'Rio:Brg:Rio'..msg.chat_id_) then
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Joker2..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(Joker2..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال البوب و سناك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(Joker2..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(Joker2..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(Joker2..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال البوب و سناك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "• نسبه الخيانه •" and DevRio:get(Joker2..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(Joker2..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Joker2..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال البوب و سناك ', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "• نسبه الجمال •" and DevRio:get(Joker2..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(Joker2..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Joker2..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال البوب و سناك و بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "• نسبه الكره •" and DevRio:get(Joker2..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(Joker2..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Joker2..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال البوب و سناك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "• نسبه الرجوله •" and DevRio:get(Joker2..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(Joker2..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Joker2..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال • بسبوسه', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "• نسبه الانوثه •" and DevRio:get(Joker2..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(Joker2..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Joker2..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال البوب و سناك ', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "• نسبه الغباء •" and DevRio:get(Joker2..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(Joker2..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل حساب العمر'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل حساب العمر'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Joker2..'Rio:Age:Rio'..msg.chat_id_) then
...
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل معاني الاسماء'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Joker2..'Rio:Mean:Rio'..msg.chat_id_) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل المتحركه'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل المتحركه'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "• متحركه •") and not DevRio:get(Joker2..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الميمز'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الميمز'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "• ميمز •") and not DevRio:get(Joker2..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل غنيلي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل غنيلي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text == "غنيلي" then
local t = "Your song"
Rv = math.random(8,83)
...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url"t.me/UU_Joker2"},
},
}
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الاغاني'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الاغاني'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "• اغنيه •" or text == "اغاني") and not DevRio:get(Joker2..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الريمكس'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الريمكس'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "• ريمكس •") and not DevRio:get(Joker2..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الصوره'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الصوره'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "• صوره •") and not DevRio:get(Joker2..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
Rio = math.random(4,1122); 
local Text ='*•︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '• 𝘿𝙀𝙑  .',url="https://t.me/UU_0P"}},
{{text = '• 𝙎𝙊??𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .',url="t.me/UU_Joker2"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الانمي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الانمي'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "• انمي •") and not DevRio:get(Joker2..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل الافلام'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل الافلام'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "• فلم •") and not DevRio:get(Joker2..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تفعيل المسلسلات'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:del(Joker2..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local Joker2Team = '•︙اهلا عزيزي • '..RioRank(msg)..' \n•︙تم تعطيل المسلسلات'
Riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, Joker2Team, 14, string.len(msg.sender_user_id_))
DevRio:set(Joker2..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "• مسلسل •") and not DevRio:get(Joker2..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Joker2:BanGroup:Group"..ChatId) 
