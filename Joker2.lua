...
local Joker2 = io.open("Joker2", 'w')
Joker2:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Joker2.lua
done
]])
Joker2:close()
...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./Joker2
done
]])
Run:close()
...
ControllerAll = false
local ListSudos ={Sudo_Id,1127091205,1127091205,1127091205,0000,000}  
...
Status = 0
DevelopersQ = Redis:sismember(Joker2.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(Joker2.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(Joker2.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(Joker2.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Joker2.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Joker2.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Joker2.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Joker2.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Joker2.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 1127091205 then
Status = 'المبرمج عباس الجابري' 
elseif tonumber(UserId) == 1127091205 then
Status = 'مبرمج السورس'
elseif tonumber(UserId) == 1127091205  then
Status = 'المبرمج عباس الجابري'
...
Status = Redis:get(Joker2.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(Joker2.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Joker2.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Joker2.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Joker2.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Joker2.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(Joker2.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Joker2.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Joker2.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❎"    
end
if Redis:get(Joker2.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❎"
end
if Redis:get(Joker2.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎ "    
end
if Redis:get(Joker2.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎ "    
end    
if Redis:get(Joker2.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎ "    
end    
if Redis:get(Joker2.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎ "    
end
if Redis:get(Joker2.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎ "    
end
if Redis:hget(Joker2.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Joker2.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Joker2.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Joker2.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎ "     
end
if Redis:get(Joker2.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(Joker2.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Joker2.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎ "   
end    
if Redis:get(Joker2.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(Joker2.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎ "    
end    
if Redis:get(Joker2.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(Joker2.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎ "    
end
if Redis:get(Joker2.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(Joker2.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Joker2.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎ "    
end
if Redis:get(Joker2.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(Joker2.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Joker2.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎ "    
end
if Redis:get(Joker2.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(Joker2.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Joker2.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎ "    
end
if Redis:get(Joker2.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(Joker2.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Joker2.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎ "    
end 
if Redis:get(Joker2.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(Joker2.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎ "    
end
if Redis:get(Joker2.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(Joker2.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎ "    
end
if Redis:get(Joker2.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(Joker2.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎ "    
end
if Redis:get(Joker2.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(Joker2.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Joker2.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎ "    
end    
...
if Redis:get(Joker2.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(Joker2.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Joker2.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎ "
end
if Redis:get(Joker2.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(Joker2.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Joker2.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎ "    
end    
if Redis:get(Joker2.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(Joker2.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎ "    
end    
if Redis:get(Joker2.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(Joker2.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎ "    
end
if Redis:get(Joker2.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(Joker2.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Joker2.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎ "    
end
if Redis:get(Joker2.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(Joker2.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎ "    
end
if Redis:get(Joker2.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(Joker2.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Joker2.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Joker2.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎ "    
end        
...
LuaTele.editMessageText(ChatId,MsgId,"𖥔  صلاحيات المجموعة - ", 'md', false, false, reply_markup)
end
function Statusrestricted(ChatId,UserId)
return{
BanAll = Redis:sismember(Joker2.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Joker2.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Joker2.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Joker2.."SilentGroup:Group"..ChatId,UserId)
}
end
...
JoinChannel = true
local Channel = Redis:get(Joker2..'Channel:Join')
if Channel then
...
Redis:sadd(Joker2.."allM"..msg.chat_id, msg.id)
if Redis:get(Joker2.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(Joker2.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(Joker2.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(Joker2.."allM"..msg.chat_id)
...
Redis:del(Joker2.."allM"..msg.chat_id)
end
end
end
...
msg.Name_Controller = 'المبرمج عباس الجابري '
...
elseif Redis:sismember(Joker2.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Joker2.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(Joker2.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Joker2.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Joker2.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Joker2.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Joker2.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Joker2.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Joker2.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Joker2.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Joker2.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Joker2.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Joker2.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Joker2.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Joker2.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Joker2.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Joker2) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Joker2.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Joker2.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Joker2.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Joker2.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 اطلق دخول ['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')\n𖥔 نورت المجموعة {'..Get_Chat.title..'}',"md")  
end
end
end
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Joker2) then
return false
end

local floods = Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Joker2.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 قام بالتكرار في المجموعة وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 قام بالتكرار في المجموعة وتم تقييده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(Joker2.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 قام بالتكرار في المجموعة وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(Joker2.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Joker2.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(Joker2..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(Joker2..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(Joker2..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(Joker2.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Joker2.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Joker2.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Joker2.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Joker2.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Joker2.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Joker2.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Joker2.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Joker2.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Joker2.."lockpin"..msg_chat_id)
...
local Videonote_Group = Redis:get(Joker2.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Joker2.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Joker2.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Joker2.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Joker2.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Joker2.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Joker2.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Joker2.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Joker2.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Joker2.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Joker2.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا استطيع تغيير صوره المجموعة لاني لست ادمن او ليست لديه الصلاحيه ","md",true)    
end
Redis:del(Joker2.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تغيير صوره المجموعة المجموعة الى ","md",true)    
end
...
local link_Group = Redis:get(Joker2.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Joker2.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Joker2.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Joker2.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Joker2.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Joker2.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Joker2.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Joker2.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Joker2.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Joker2.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Joker2.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Joker2.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Joker2.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Joker2.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Joker2.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Joker2.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Joker2.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Joker2.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Joker2.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Joker2.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Joker2.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Joker2.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Joker2.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Joker2.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*𖥔 لقد تم منع هذه ( "..statusfilter.." ) هنا*\n𖥔 "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(Joker2.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Joker2.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Joker2.."All:Get:Reides:Commands:Group"..text)
Redis:del(Joker2.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Joker2.."All:Command:List:Group",text)
...
Redis:del(Joker2.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Joker2.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Joker2.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Joker2.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Joker2.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Joker2.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Joker2.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Joker2.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Joker2.."All:Command:List:Group",text)
Redis:del(Joker2.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(Joker2.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Joker2.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Joker2.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(Joker2.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Joker2.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Joker2.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Joker2.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Joker2.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Joker2.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Joker2.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Joker2.."Command:List:Group"..msg_chat_id,text)
Redis:del(Joker2.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Joker2.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Joker2.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Joker2.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Joker2.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:del(Joker2.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Joker2.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ ترحيب المجموعة","md",true)     
end
if Redis:get(Joker2.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Joker2.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Joker2.."Group:Rules" .. msg_chat_id,text) 
Redis:del(Joker2.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ قوانين المجموعة","md",true)  
end  
if Redis:get(Joker2.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Joker2.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ وصف المجموعة","md",true)   
end 
LuaTele.setChatDescription(msg_chat_id,text) 
Redis:del(Joker2.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ وصف المجموعة","md",true)  
end  

if Redis:get(Joker2.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(Joker2.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Joker2.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Joker2.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Joker2.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Joker2.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Joker2.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Joker2.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Joker2.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Joker2.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Joker2.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(Joker2.."PinMsegees:"..v,text)
end
end
...
local list = Redis:smembers(Joker2..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Joker2.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Joker2.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(Joker2.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Joker2.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(Joker2.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(Joker2.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Joker2.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(Joker2.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(Joker2.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(Joker2.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(Joker2.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Joker2.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(Joker2.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Joker2.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Joker2.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Joker2.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(Joker2.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(Joker2.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Joker2.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Joker2.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Joker2.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Joker2.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= Joker2 then
local test = Redis:get(Joker2.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Joker2.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Joker2.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Joker2.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Joker2.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Joker2.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Joker2.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Joker2.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Joker2.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Joker2.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Joker2.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Joker2.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Joker2.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Joker2.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(Joker2.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Joker2.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Joker2.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Joker2.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Joker2.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(Joker2.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Joker2..v..text)
end
Redis:del(Joker2.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Joker2.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(Joker2..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(Joker2.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Joker2.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Joker2.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Joker2.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Joker2.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(Joker2.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(Joker2.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(Joker2.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(Joker2.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Joker2.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(Joker2.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(Joker2.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Joker2..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Joker2..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(Joker2.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(Joker2.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Joker2.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Joker2.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Joker2.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Joker2.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(Joker2.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(Joker2.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(Joker2.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(Joker2.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Joker2.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(Joker2.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(Joker2.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Joker2..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Joker2..'GetTexting:DevJoker2'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(Joker2..'GetTexting:DevJoker2'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم الغاء حفظ كليشة المطور')
end
Redis:set(Joker2..'Texting:DevJoker2',text)
Redis:del(Joker2..'GetTexting:DevJoker2'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم حفظ كليشة المطور')
end
if Redis:get(Joker2.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Joker2.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Joker2.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Joker2.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي عام',"md",true)  
end
if Redis:get(Joker2.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي","md",true)  
Redis:del(Joker2.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Joker2.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Joker2.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Joker2.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(Joker2.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Joker2.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Joker2.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Joker2.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(Joker2.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Joker2.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Joker2.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Joker2.."Game:Smile"..msg.chat_id) then
...
local GETNUM = Redis:get(Joker2.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Joker2.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Joker2.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Joker2.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Joker2.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Joker2.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Joker2.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Joker2.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Joker2.."Game:Difference"..msg.chat_id) then
...
if text then
local NewCmmd = Redis:get(Joker2.."All:Get:Reides:Commands:Group"..text) or Redis:get(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Joker2..'Channel:Join')}, },}}
...
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 جاري استرجاع المشتركين والمجموعةات ...')
Y = 0
for k,v in pairs(FilesJson.UsersBot) do
Y = Y + 1
Redis:sadd(Joker2..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Joker2.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Joker2.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Joker2.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Joker2.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Joker2.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Joker2.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه جوكر' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
Redis:sadd(Joker2.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Joker2.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Joker2.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Joker2.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Joker2.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم استرجاع المجموعات من نسخه جوكر')
else
...
Redis:set(Joker2.."SendBcBot",true) 
...
Redis:set(Joker2.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Joker2.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(Joker2.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(Joker2..'ChekBotAdd')  
local UsersBot = Redis:smembers(Joker2..'Num:User:Pv')  
...
local President = Redis:smembers(Joker2.."TheBasics:Group"..v)
local Constructor = Redis:smembers(Joker2.."Originators:Group"..v)
local Manager = Redis:smembers(Joker2.."Managers:Group"..v)
local Admin = Redis:smembers(Joker2.."Addictive:Group"..v)
local Vips = Redis:smembers(Joker2.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(Joker2..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(Joker2..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,Joker2).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Joker2..'Channel:Join',ChannelUser) 
...
Redis:set(Joker2..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:set(Joker2..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖥔 عدد احصائيات البوت الكامله \n⩹━━━━𖥕Joker2𖥕━━━━⩺\n𖥔 عدد المجموعات : '..(Redis:scard(Joker2..'ChekBotAdd') or 0)..'\n𖥔 عدد المشتركين : '..(Redis:scard(Joker2..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(Joker2.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Joker2..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Joker2..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Joker2.."ChekBotAdd",msg_chat_id)
Redis:set(Joker2.."Status:Id"..msg_chat_id,true) ;Redis:set(Joker2.."Status:Reply"..msg_chat_id,true) ;Redis:set(Joker2.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Joker2.."Status:BanId"..msg_chat_id,true) ;Redis:set(Joker2.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Joker2.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Joker2.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(Joker2.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Joker2.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(Joker2.."Status:Id"..msg_chat_id) then
return false
end
...
Get_Is_Id = Redis:get(Joker2.."Set:Id:Groups") or Redis:get(Joker2.."Set:Id:Group"..msg_chat_id)
if Redis:get(Joker2.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Joker2..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Joker2..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Joker2.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Joker2.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
Redis:set(Joker2.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(Joker2.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Joker2.."allM"..msg.chat_id)  
...
Redis:del(Joker2.."Status:Del:Media"..msg.chat_id)
...
Redis:set(Joker2.."Status:Del:Media"..msg.chat_id,true)
...
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 البوت عضو في المجموعة ',"md",true) 
end
...
if not Redis:sismember(Joker2.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Joker2.."HELPBEVQ:Groups")
Redis:del(Joker2.."HELPBEVQ:Groups", bana.id)
Redis:del(Joker2.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(Joker2.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Developers:Groups",bana.id) 
...
if not Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(Joker2.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(Joker2.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(Joker2.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(Joker2.."HELPBEVQ:Groups")
Redis:del(Joker2.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(Joker2.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(Joker2.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Joker2.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Joker2.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Joker2.."HELPBEVQ:Groups")
Redis:del(Joker2.."HELPBEVQ:Groups", UserId)
Redis:del(Joker2.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(Joker2.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Developers:Groups",UserId) 
...
if not Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Joker2.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Joker2.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Joker2.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Joker2.."HELPBEVQ:Groups")
Redis:sadd(Joker2.."HELPBEVQ:Groups", UserId)
Redis:set(Joker2.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(Joker2.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(Joker2.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(Joker2.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(Joker2.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(Joker2.."HELPBEVQ:Groups")
Redis:sadd(Joker2.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(Joker2.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(Joker2.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Joker2.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Joker2.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Joker2.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Joker2.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Joker2.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Joker2.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Joker2.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Joker2.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Joker2.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Joker2.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Joker2.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Joker2.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Joker2.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(Joker2.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Joker2.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Joker2.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Joker2.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Joker2.."Status:Id"..msg_chat_id,true) 
...
Redis:set(Joker2.."rb:bna"..msg_chat_id,true) 
...
Redis:set(Joker2.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Joker2.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(Joker2.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Joker2.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(Joker2.."TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(Joker2.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Joker2.."Status:Welcome"..msg_chat_id) 
...
if TextMsg == 'ردود السورس' then
Redis:del(Joker2.."rb:bna"..msg_chat_id) 
...
Redis:del(Joker2.."Status:Id"..msg_chat_id) 
...
Redis:del(Joker2.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Joker2.."Status:Reply"..msg_chat_id) 
...
Redis:del(Joker2.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Joker2.."Status:BanId"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ لا تستطيع استخدام الامر على ⦗ "..Controller(msg_chat_id,bana.id).." ⦘ *","md",true)  
end
if StatusCanOrNotCan(msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ لا تستطيع استخدام الامر على ⦗ "..Controller(msg_chat_id,bana.id).." ⦘ *","md",true)  
end
if Redis:sismember(Joker2.."BanAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."BanAll:Groups",bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Joker2.."BanAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."BanAll:Groups",bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."ktmAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."ktmAll:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Joker2.."ktmAll:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."ktmAll:Groups",bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(Joker2.."Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local bana = LuaTele.searchPublicChat(UserName)
if not bana.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 عذرآ لا يوجد حساب بهاذا المعرف ","md",true)  
...
if Redis:sismember(Joker2.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم حظره من المجموعة ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Joker2.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء حظره من المجموعة  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم كتمه في المجموعة  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Joker2.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(Joker2.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تقييده في المجموعة \n𖥔 لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ لا تستطيع استخدام الامر على ⦗ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ⦘ *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم تقييده في المجموعة \n𖥔 لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ لا تستطيع استخدام الامر على ⦗ "..Controller(msg_chat_id,UserId[3]).." ⦘ *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم الغاء تقييده من المجموعة").Reply,"md",true)  
end
...
if Redis:sismember(Joker2.."BanAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم حظره عام من المجموعات\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
if not Redis:sismember(Joker2.."BanAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."ktmAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."ktmAll:Groups",Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في المجموعة\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(Joker2.."ktmAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."ktmAll:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم حظره من المجموعة\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
if not Redis:sismember(Joker2.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء حظره من المجموعة  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في المجموعة\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(Joker2.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(Joker2.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𖥔 تم الغاء تقييده من المجموعة").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ لا تستطيع استخدام الامر على المطور عباس الجابري *","md",true)  
end
if UserId == "1127091205" then
...
if not Redis:sismember(Joker2.."BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."BanAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."ktmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."ktmAll:Groups",UserId) 
if ban.first_name then
...
if not Redis:sismember(Joker2.."ktmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."ktmAll:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم الغاء حظره من المجموعة \nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
if not Redis:sismember(Joker2.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:srem(Joker2.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء حظره من المجموعة  ").Reply,"md",true)  
end
end
...
if Redis:sismember(Joker2.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(Joker2.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n𖥔 تم كتمه في المجموعة\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
end
keyboard = {} 
...
if not Redis:sismember(Joker2.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(Joker2.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم الغاء تقييده من المجموعة").Reply,"md",true)  
end
...
if text == "نزلني" then
if not Redis:get(Joker2.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Joker2.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Joker2.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Joker2.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Joker2.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Joker2.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Joker2.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(Joker2.."Status:KickMe"..msg_chat_id) then
...
if KickMe == true then
return LuaTele.sendText(msg_chat_id,msg_id,"*𖥔 عذرا لا استطيع طرد ادمنيه ومنشئين المجموعة*","md",true)    
end
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"𖥔 تم طردك من المجموعة بنائآ على طلبك").Reply,"md",true)  
end
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Joker2.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Joker2.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ❲ Developers Joker2  ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
local Added_Me = Redis:get(Joker2.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if not Redis:get(Joker2.."rb:bna"..msg_chat_id) then
...
if Redis:get(Joker2.."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(Joker2.."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(Joker2.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(Joker2.."cleaner"..msg_chat_id)
...
if Redis:get(Joker2.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(Joker2.."LeftBot") then
...
Redis:set(Joker2.."Lock:text"..msg_chat_id,true) 
...
Redis:set(Joker2.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Joker2.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Joker2.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Joker2.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Joker2.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Joker2.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(Joker2.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Joker2..''..lock..msg_chat_id,"del")    
end
...
Redis:del(Joker2.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Joker2.."Lock:text"..msg_chat_id)  
...
Redis:del(Joker2.."Lock:Join"..msg_chat_id)  
...
Redis:del(Joker2.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Joker2.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(Joker2.."lockpin"..msg_chat_id)  
...
Redis:del(Joker2.."Lock:edit"..msg_chat_id) 
...
Redis:del(Joker2.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Joker2..''..lock..msg_chat_id)    
end
...
Redis:hset(Joker2.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Joker2.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Joker2.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Joker2.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Joker2.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Joker2.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Link"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(Joker2..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(Joker2..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(Joker2..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(Joker2..'lock:Fshar'..msg.chat_id) 
...
Redis:del(Joker2..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم فتح السب").unLock,"md",true)  
end
...
Redis:del(Joker2..'lock:Fars'..msg.chat_id) 
...
Redis:del(Joker2.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Photo"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Video"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Animation"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:geam"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Audio"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:vico"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:forward"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Document"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Contact"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Spam"..msg_chat_id)  
...
Redis:set(Joker2.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Joker2.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Joker2.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Joker2.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Joker2.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Joker2.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
if not Redis:get(Joker2.."Status:Welcome"..msg_chat_id) then
...
Redis:del(Joker2.."Welcome:Group"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة ترحيب المجموعة","md",true)   
end
...
Redis:setex(Joker2.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Joker2.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة قوانين المجموعة","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Joker2.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Joker2.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل لي وصف المجموعة الان","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تغيير اسم المجموعة الى : "..NameChat,"md",true)    
end
...
Redis:set(Joker2.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Joker2.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Joker2.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(Joker2.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Joker2.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Joker2..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Joker2.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Joker2.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Joker2.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Joker2.."All:Get:Reides:Commands:Group"..v)
Redis:del(Joker2.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Joker2.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Joker2.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Joker2.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Joker2.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Joker2.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Joker2.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(Joker2.."Status:AddMe"..msg.chat_id) then
StatusAddme = '❬ ✅ ❭' else StatusAddme = '❬ ❎ ❭'
end
local protectionGroup = '\n*𖥔 اعدادات حمايه المجموعة\n ⩹━━━━𖥕Joker2𖥕━━━━⩺\n'
...
data = {
{
{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', url = 't.me/iHHHHH'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Joker2.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Joker2.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Joker2.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Joker2.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(Joker2.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(Joker2.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(Joker2.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(Joker2.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(Joker2.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(Joker2.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(Joker2.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(Joker2.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(Joker2..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Joker2..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Joker2..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد رسائلك هنا *~ '..(Redis:get(Joker2..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد التعديلات هنا *~ '..(Redis:get(Joker2..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد جهاتك المضافه هنا *~ '..(Redis:get(Joker2.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Joker2.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
...
Redis:del(Joker2.."Set:Id:Groups")
...
Redis:setex(Joker2.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
𖥔 `#username` » اسم المستخدم
...
Redis:del(Joker2.."Set:Id:Group"..msg.chat_id)
...
Redis:del(Joker2.."DevelopersQ:Groups") 
...
Redis:del(Joker2.."Developers:Groups") 
...
Redis:del(Joker2.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(Joker2.."Originators:Group"..msg_chat_id) 
...
Redis:del(Joker2.."Managers:Group"..msg_chat_id) 
...
Redis:del(Joker2.."Addictive:Group"..msg_chat_id) 
...
Redis:del(Joker2.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(Joker2.."BanAll:Groups") 
...
Redis:del(Joker2.."ktmAll:Groups") 
...
Redis:del(Joker2.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(Joker2.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Joker2.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Joker2.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Joker2.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Joker2.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Joker2.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Joker2.."List:Manager"..msg_chat_id)
end
...
text = "𖥔 قائمه الردود \n⩹━━━━𖥕Joker2𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(Joker2.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Joker2.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Joker2.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Joker2.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Joker2.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Joker2.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Joker2.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 𖥔"
elseif Redis:get(Joker2.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Joker2.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
if #list == 0 then
text = "𖥔 عذرا لا يوجد ردود للمدير في المجموعة"
end
return LuaTele.sendText(msg_chat_id,msg_id,"["..text.."]","md",true)  
end
if text == "اضف رد" then
...
Redis:set(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Joker2.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(Joker2.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(Joker2.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(Joker2.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Joker2.."Add:Rd:Sudo:Gif"..v)   
Redis:del(Joker2.."Add:Rd:Sudo:vico"..v)   
Redis:del(Joker2.."Add:Rd:Sudo:stekr"..v)     
Redis:del(Joker2.."Add:Rd:Sudo:Text"..v)   
Redis:del(Joker2.."Add:Rd:Sudo:Photoc"..v)
Redis:del(Joker2.."Add:Rd:Sudo:Photo"..v)
Redis:del(Joker2.."Add:Rd:Sudo:Video"..v)
Redis:del(Joker2.."Add:Rd:Sudo:File"..v)
Redis:del(Joker2.."Add:Rd:Sudo:Audio"..v)
Redis:del(Joker2.."Add:Rd:Sudo:video_note"..v)
Redis:del(Joker2.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n⩹━━━━𖥕Joker2𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(Joker2.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Joker2.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Joker2.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Joker2.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Joker2.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Joker2.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Joker2.."Add:Rd:Sudo:File"..v) then
db = "ملف 𖥔"
elseif Redis:get(Joker2.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Joker2.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Joker2.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Joker2.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Joker2.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:set(Joker2..'GetTexting:DevJoker2'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Joker2..'Texting:DevJoker2')
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪',url="https://t.me/iHHHHH"}}
}
local msg_id = msg.id/2097152/0.5
...
photo = "https://t.me/iHHHHH"
local Name = '* ╭───── •𖥔• ─────╮\n*𖥔 [𝑆𝑂𝑈𝑅𝐶𝐸 Joker](t.me/iHHHHH)*\n*𖥔 [𝑰𝑵𝑭𝑶 𝑺𝑶𝑼𝑹𝑪𝑬](t.me/BBTBB)*\n*𖥔 [𝑮𝑹𝑶𝑼𝑷 𝑻𝑾𝑺](t.me/FFWFF)*\n*𖥔 [𝑫𝑬𝑽 source Joker](t.me/FFMFF)*\n*𖥔 [𝑫𝑬𝑽 source Abbas](t.me/BBTBB)*\n╰───── • 𖥔 • ─────╯\n⍟ 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻 𝑶𝑵 𝑺𝑶𝑼𝑹𝑪𝑬 ⏎*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
...
Redis:setex(Joker2.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local ban = LuaTele.getUser(Joker2)
local Namebot = (Redis:get(Joker2.."Name:Bot") or "جوكر")
local BotName = {
...
if text == (Redis:get(Joker2.."Name:Bot") or "جوكر") then
local photo = LuaTele.getUserProfilePhotos(Joker2)
local ban = LuaTele.getUser(Joker2)
local Namebot = (Redis:get(Joker2.."Name:Bot") or "جوكر")
local BotName = {
...
x = x + 1
Redis:srem(Joker2..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:set(Joker2.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(Joker2.."Status:Games"..msg.chat_id) then
Redis:del(Joker2.."Set:Country"..msg.chat_id)
...
Redis:set(Joker2.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(Joker2.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Joker2.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Joker2.."Status:Games"..msg.chat_id) then
Redis:del(Joker2.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Joker2.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Joker2.."Status:Games"..msg.chat_id) then
Redis:del(Joker2.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Joker2.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(Joker2.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Joker2.."Game:Difference"..msg.chat_id,name)
...
Redis:set(Joker2.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Joker2.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Joker2.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Joker2.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Joker2.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Joker2.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Joker2.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Joker2.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local ban = LuaTele.getUser(Joker2)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(Joker2..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Joker2.."Start:Bot") then
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(Joker2.."Name:Bot") or "جوكر")..
'\n𖥔 اختصاص البوت حماية المجموعات'..
'\n𖥔 لتفعيل البوت عليك اتباع مايلي ...'..
'\n𖥔 اضف البوت الى مجموعتك'..
'\n𖥔 ارفعه ادمن {مشرف}'..
'\n𖥔 ارسل كلمة { تفعيل } ليتم تفعيل المجموعة'..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Joker2.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
Redis:setex(Joker2.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(Joker2.."TwaslBot") and not Redis:sismember(Joker2.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Joker2.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Joker2.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Joker2..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'𖥔 تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Joker2..'BaN:In:Tuasl',Info_User)  
...
Redis:srem(Joker2.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Joker2..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Joker2.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(Joker2.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
return LuaTele.sendText(Sudo_Id,0,'*\n𖥔 تم طرد البوت من مجموعه جديده \n𖥔 اسم المجموعة : '..Get_Chat.title..'\n𖥔 ايدي المجموعة :*`-100'..data.supergroup.id..'`\n𖥔 تم مسح جميع البيانات المتعلقه بالمجموعة',"md")
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Joker2.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Joker2.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Joker2.."Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Joker2..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:incr(Joker2..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Joker2.."Lock:edit"..data.chat_id) then
...
local TextHelp = [[*
𖥔 اوامر ادمنية المجموعة ...
⩹━━━━𖥕Joker2𖥕━━━━⩺
𖥔 رفع، تنزيل ↵ مميز
𖥔 تاك للكل ، عدد المجموعة
𖥔 كتم ، حظر ، طرد ، تقييد
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس جوكر اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس جوكر 
...
Redis:set(Joker2.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖥔 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(Joker2.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(Joker2.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(Joker2.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Joker2.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Joker2.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Joker2.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Joker2.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."rb:bna"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Joker2.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Joker2.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Joker2.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Joker2.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Joker2..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(Joker2.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Joker2..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "𖥔 تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
LuaTele.answerCallbackQuery(data.id, "𖥔 تم مغادره البوت من المجموعة", true)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Joker2.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Originators:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"𖥔 تم مسح منشئين المجموعة", 'md', false)
end
elseif Text and Text:match('(%d+)/Managers') then
local UserId = Text:match('(%d+)/Managers')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Addictive:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"𖥔 تم مسح ادمنيه المجموعة", 'md', false)
end
elseif Text and Text:match('(%d+)/DelDistinguished') then
local UserId = Text:match('(%d+)/DelDistinguished')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Joker2.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
